...
import { Play, Users, Trophy, Gamepad2, Youtube, Twitch, Twitter, Instagram, Mail, Clock } from "lucide-react"
import Link from "next/link"
import YouTubeSubscriberCount from "@/components/youtube-subscriber-count"
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-4" style={{ gap: '24px', maxWidth: '896px', margin: '0 auto' }}>
            {socialLinks.map((social, index) => {
              ...
              return (
                <Link key={index} href={social.url} style={{ textDecoration: 'none' }}>
